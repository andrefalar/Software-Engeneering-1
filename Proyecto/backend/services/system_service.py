...
class SystemService:
    ...
    def reset_system(self, confirmation_text: str = None) -> dict:
        ...
        try:
            ...
            return {
                "success": False,
                "message": f"Error al reiniciar sistema: {e}"
            }
    ...
    def get_system_status(self) -> dict:
        ...
        try:
            ...
            if status["secure_files_dir_exists"]:
                ...
                status["secure_files_count"] = len([f for f in files if os.path.isfile(os.path.join("secure_files", f))])
    ...
    def backup_system(self, backup_path: str) -> dict:
        ...
        try:
            ...
            if os.path.exists("fortifile.db"):
                shutil.copy2("fortifile.db", os.path.join(backup_path, "fortifile_backup.db"))
    ...
    def verify_system_integrity(self) -> dict:
        ...
        try:
            ...
            try:
                ...
                for db_file in db_files:
                    if not os.path.exists(db_file.ruta_archivo):
                        issues.append(f"Archivo referenciado en BD no existe: {db_file.nombre_archivo}")
            ...
            return {
                "success": False,
                "message": f"Error verificando integridad: {e}"
            }
